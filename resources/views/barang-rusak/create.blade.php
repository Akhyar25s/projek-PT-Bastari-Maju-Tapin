...
@section('page_title', 'Tambah Barang Rusak')
...
@section('content')
    ...
    <div style="background: white; padding: 30px; border-radius: 8px; max-width: 600px;">
        <h2 style="margin-bottom: 25px; color: #333; font-size: 24px;">Tambah Barang Rusak</h2>
        ...
        <form action="{{ route('barang-rusak.store') }}" method="POST">
            ...
            <div style="margin-bottom: 25px;">
                ...
                <input type="text" 
                       name="keterangan" 
                       id="keterangan" 
                       value="{{ old('keterangan', 'Rusak') }}" 
                       placeholder="Keterangan (default: Rusak)"
                       style="width: 100%; padding: 12px; border: 2px solid #e0e0e0; border-radius: 8px; font-size: 15px; background: #f9f9f9;"
