            ...
            <table style="width: 100%; border-collapse: collapse; background: white; font-size: 12px;">
                ...
                <tbody>
                    ...
                    <tr style="border-bottom: 1px solid #eee;">
                        ...
                        <td style="padding: 8px 6px; text-align: center; color: #333; font-size: 11px; border: 1px solid #eee;">{{ $item->tap_sel ?? 0 }}</td>
                        ...
                        <td style="padding: 8px 6px; text-align: center; color: #333; font-size: 11px; border: 1px solid #eee;">{{ $item->tap_tengah ?? 0 }}</td>
                        <td style="padding: 8px 6px; text-align: center; color: #333; font-size: 11px; border: 1px solid #eee;">{{ $item->batu_hapu ?? 0 }}</td>
