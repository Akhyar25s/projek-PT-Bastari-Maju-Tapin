...
@section('page_title', 'Detail Rekap GM')
...
@section('content')
    ...
    <div style="background: white; padding: 30px; border-radius: 8px; overflow-x: hidden;">
        <h2 style="font-size: 24px; font-weight: bold; margin-bottom: 25px; color: #333; padding-bottom: 10px; border-bottom: 3px solid var(--accent); overflow-x: hidden; width: 100%;">
            Detail Rekap GM - {{ $item->nama_bulan }}
        </h2>
            ...
            <table class="detail-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>{{ $item->salba ?? 0 }}</td>
                        <td>{{ $item->piani ?? 0 }}</td>
                        <td style="font-weight: bold; background: var(--accent);">{{ $item->jumlah ?? 0 }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
