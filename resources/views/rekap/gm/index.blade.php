...
@section('page_title', 'Rekap GM')

@section('content')
<div class="content-wrapper">
    <div class="content-header">
        <h1 class="text-2xl font-bold">Rekap GM</h1>
    </div>
        ...
        <table class="min-w-full">
            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-50">
                    ...
                    <td class="py-3 px-4">
                        <a href="{{ route('rekap.gm.show', $item->gm) }}" class="text-blue-500 hover:underline">Detail</a>
                    </td>
                </tr>
                @empty
                <tr>
                    <td colspan="13" class="py-3 px-4 text-center text-gray-500">Tidak ada data rekap GM</td>
                </tr>
                @endforelse
            </tbody>
        </table>
