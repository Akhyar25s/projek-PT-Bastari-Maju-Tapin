...
@section('content')
    <div style="background: #fff3cd; padding: 15px; border-radius: 8px; margin-bottom: 20px; border: 2px solid var(--yellow);">
        <strong>Info:</strong> Anda login sebagai Direktur. Mode read-only - Anda hanya dapat melihat data tanpa dapat mengubah atau menghapus.
    </div>
    ...
    <div style="background: white; padding: 25px; border-radius: 8px; margin-bottom: 30px; border: 2px solid var(--accent);">
        ...
        <!-- Tabel Status Pesanan (Read Only - tanpa tombol aksi) -->
        <div style="overflow-x: auto;">
            <table style="width: 100%; border-collapse: collapse;">
                ...
                <tbody>
                    ...
                    @empty
                    <tr>
                        <td colspan="5" style="padding: 40px; text-align: center; color: #999; border: 1px solid #eee;">
                            Tidak ada pesanan
                        </td>
                    </tr>
                    @endforelse
